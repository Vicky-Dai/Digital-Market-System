...
public class DigitalMarketingApplication {
  ...
  public static void main(String[] args) {
    ...
    Business business = ConfigureABusiness.createABusinessAndLoadALotOfData("Mario Market", 50, 30, 50,
        500, 5, 5);
    // TODO output business information header
    MarketCatalog marketCatalog = business.getMarketcatalog();
    // all kinds of reports
    business.printBusinessDemo();

    // MarketReport mp = business.prepareMarketReport(marketCatalog);
    // mp.printMarketReport();
    // System.out.println();

    ChannelReport cp = business.prepareChannelReport();
    cp.printChannelReport();
    cp.sortByEfficiency();
    System.out.println();
    System.out.println("After sorting by efficiency");
    cp.printChannelReport();

    AdvertisingCostReport acr = business.prepareAdvertisingCostReport();
    acr.printReport();
